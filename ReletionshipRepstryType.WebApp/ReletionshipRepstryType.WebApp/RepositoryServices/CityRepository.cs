...
{
    public class CityRepository : RepositoryService<City, CityVm>, ICityRepository
    {
        public CityRepository(IMapper mapper, ApplicationDbContext dbContext) : base(mapper, dbContext)
        {
        }
    }
}
